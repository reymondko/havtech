...
class LoginController extends Controller
{
    ...
    */
    ...
    {
        // Check if user has requested a password reset within the past 48 hours
        // if true clear login attempts
        $hasReset = PasswordResets::where('email', $request->email)
        ...
        if(Auth::attempt(['email' => $request->email, 'password' => $request->password,'deleted' => 0,'enabled'=>1])) {
