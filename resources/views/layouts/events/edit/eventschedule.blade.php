    ...
    <div class="panel panel-default">
        <div class="panel-heading event-heading">
            <h3 class="panel-title">Itinerary <span class="itinum"></span> 
                ...
                <span id="delbtnhldr">
                    <button type="button" onclick="$('#event_schedule1').remove();colorize()" id="deleteSchedule" class="tn btn-default btn-outline pull-right"><i class="fa fa-minus-circle"></i> Delete </button>
                </span>
            </h3>
        </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select id="location" name="location[]" required class="form-control " >
                            <option selected>Specify Address</option>
...
<form id="eventscheduleform" enctype="multipart/form-data" method="post" >
    <div class="row">
        ...
        <div class="col-md-1 pull-right update-btn-top">
            <button class="btn btn-default btn-block btn-blue update-evt-sched" onclick="$('#eventscheduleform').submit();" id="update_event" >Update</button>
        </div>
    </div>                                
    @csrf 
    <div class="row">
            ...
            <div class="panel panel-default">
                <div class="panel-heading event-heading" data-toggle="collapse" data-target="#panel{{$key +1}}" style="cursor: pointer">
                    <h3 class="panel-title" >Itinerary #{{$key +1}}  
                        : <span id="iti_title" >{{$es['title']}}</span>
                        <span id="delbtnhldr">
                ...
                <div class="panel-body collapse" id="panel{{$key +1}}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group"> 
                                <label>Start Date:</label>                                        
                                <select id="start_dateonly" name="start_dateonly[]" class="form-control"  autocomplete="off"  required>
                                    @foreach ($datez as $d )
                    ...
                    <div class="row"> 
                        <div class="col-md-4">
                            ...
                            <div class="form-group"> 
                                <label>End Date:</label>                                        
                                <select id="end_dateonly" name="end_dateonly[]" class="form-control"  autocomplete="off" required>
                                    @foreach ($datez as $d )
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Start Time:</label>
                                <input  type="text" id="start_time" name="start_time[]" value="{{date('h:i A',strtotime($es['start_date']))}}" class="form-control timepicker"  autocomplete="off" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>End Time:</label>
                                <input  type="text" id="end_time" name="end_time[]" value="{{date('h:i A',strtotime($es['end_date']))}}" class="form-control timepicker"  autocomplete="off" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
        ...
        <div class="col-md-12">
            <div class="panel panel-default">	  
                <div class="panel-heading">
                    <h3 class="panel-title"><span  class="pull-left">ITINERARY </span> &nbsp; <button onclick="cloneSchedule()" id="add_moreSchedule" class="btn btn-default btn-outline pull-right"><i class="fa fa-plus-circle"></i> ADD </button></a>                                
                </div>     
            </div>                        
        </div>
    </div>
