        ...
        <div class="panel-body">
            <!--<div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="col-md-11">
                        <input type="file" id="event_info_file" name="event_info_file[]" class="form-control banner_image"  autocomplete="off" >
                    </div>  
                </div>
            </div>!-->
            <div class="row">                 
...
<form id="travelhostinformationform" enctype="multipart/form-data" method="post" > 
    <div class="row">
        ...
        <div class="col-md-1 pull-right update-btn-top">
            <button class="btn btn-default btn-block btn-blue" onclick="$('#travelhostinformationform').submit();" id="update_event" >Update</button>
        </div>           
    </div>                                    
    @csrf 
    <div class="row">
