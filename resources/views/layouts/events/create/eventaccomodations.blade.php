...
<div class="col-md-12">
    <div class="row">
        <div class="col-md-9">
            <h1 class="form-title">Accommodations  (Step {{$step}})</h1>
        </div>
            <!-- Circles which indicates the steps of the form: -->
        <div class="col-md-3 pull-right"> 
            <div class="form-group" style="margin-top:40px">        
                <label>Step <span class="counter">{{$step}}</span> of {{$total}}  </label>                                                
    ...
    <div class="row" style="margin-top:20px">
        <div class="col-md-12">           
            ...
            <div class="tab">
                <form id="eventaccomodationsform" enctype="multipart/form-data" method="post" >
                        ...
                        @foreach ($data['eventaccs'] as $key => $es)                  
                            <div id="accomodations{{$key +1}}" class="accomodations">
                                <div class="panel panel-default">
                                    <div class="panel-heading event-heading" data-toggle="collapse" data-target="#panel{{$key +1}}">
                                        <h3 class="panel-title">Accommodations #{{$key +1}}  
                                            : <span id="iti_title" >{{$es['hotel']}}</span>
                                            <span id="delbtnhldr">
                ...
                <div class="row">
                    <div class="col-md-2">
                        <button class="btn " onclick="cancelEvent({{$event->id}})"  type="button">Cancel</button>
                    </div>
                    <div class="col-md-6" style="text-align:center;"> 
                        <div class="form-group">        
                            <label>Step <span class="counter2">{{$step}}</span> of {{$total}}   </label>                                                
                            <div class="radio-inline bottomcounter">
                                @for($x=1;$x<$total+1;$x++)                    
                                    <span class="step @if ($step == $x) active @endif" ></span>
                                @endfor
