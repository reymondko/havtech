...
<div class="col-md-12">
    <div class="row">
        <div class="col-md-9">
            <h1 class="form-title">Dining  (Step {{$step}})</h1>
        </div>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading event-heading" data-toggle="collapse" data-target="#panel{{$key +1}}" style="cursor: pointer">
                                    <h3 class="panel-title">Dining #{{$key +1}}  
                                        : <span id="iti_title" >{{$edata['location']}}</span>
                                        <span id="delbtnhldr">
                            ...
                            <div class="panel panel-default">	  
                                <div class="panel-heading">
                                    <h3 class="panel-title"><span  class="pull-left">DINING</span> &nbsp; 
                                        <button onclick="cloneDining()" id="add_moreDining" class="btn btn-default btn-outline pull-right"><i class="fa fa-plus-circle"></i> ADD </button></a>                                                            </div>     
                            </div>                        
                        </div>
                    </div>
                </div>
                <!-- end step 4 Event Dining!-->  
